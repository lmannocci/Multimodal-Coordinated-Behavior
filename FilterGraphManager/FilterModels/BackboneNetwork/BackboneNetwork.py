...
class BackboneNetwork:
    ...
    '''
    def disparity_filter(self, G, weight='weight'):
        ...
        self.lm.printl(f"{file_name}. disparity_filter start")
        if nx.is_directed(G):  # directed case
            ...
            for u in G:
                ...
                if k_out > 1:
                    ...
                    for v in G.successors(u):
                        ...
                        alpha_ij_out = 1 - (k_out - 1) * integrate.quad(lambda x: (1 - x) ** (k_out - 2), 0, p_ij_out)[
                            0]
            ...
            self.lm.printl(f"{file_name}. disparity_filter completed")
            return N
    ...
    def disparity_filter_alpha_cut(self, G, weight='weight', alpha_t=0.4, cut_mode='or'):
